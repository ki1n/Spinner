...
public class MainActivity extends AppCompatActivity {
    ...
    // реализуем присвоение данных и соответствующий функционал выбора стран
    ...
    //  реализуем инициализацию Spinner-а номера домов:
...
//    Выбор одного из значений mCountriesSpinner можно зарегистрировать в методе *setOnItemSelectedListener()*,
//    с реализацией интерфейса *AdapterView.OnItemSelectedListener()*,
//    после нужно осуществить переопределение метода *onItemSelected()*.
